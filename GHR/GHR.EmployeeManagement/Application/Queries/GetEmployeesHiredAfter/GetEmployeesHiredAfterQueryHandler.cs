namespace GHR.EmployeeManagement.Application.Queries.GetEmployeesHiredAfter
{
    ...
    public class GetEmployeesHiredAfterQueryHandler : IRequestHandler<GetEmployeesHiredAfterQuery, IdentityResult<IEnumerable<EmployeeDTO>>>
    {
        private readonly IEmployeeService _employeeService;
        public GetEmployeesHiredAfterQueryHandler(IEmployeeService employeeService) => _employeeService = employeeService;
        public async Task<IdentityResult<IEnumerable<EmployeeDTO>>> Handle(GetEmployeesHiredAfterQuery request, CancellationToken cancellationToken)
        {
