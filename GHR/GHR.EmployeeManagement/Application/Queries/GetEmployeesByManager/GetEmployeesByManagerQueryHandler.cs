namespace GHR.EmployeeManagement.Application.Queries.GetEmployeesByManager
{
    ...
    public class GetEmployeesByManagerQueryHandler : IRequestHandler<GetEmployeesByManagerQuery, IdentityResult<IEnumerable<EmployeeDTO>>>
    {
        private readonly IEmployeeService _employeeService;
        public GetEmployeesByManagerQueryHandler(IEmployeeService employeeService) => _employeeService = employeeService;
        public async Task<IdentityResult<IEnumerable<EmployeeDTO>>> Handle(GetEmployeesByManagerQuery request, CancellationToken cancellationToken)
        {
