namespace GHR.EmployeeManagement.Application.Queries.GetEmployeesByFacility
{
    ...
    public class GetEmployeesByFacilityQueryHandler : IRequestHandler<GetEmployeesByFacilityQuery, IdentityResult<IEnumerable<EmployeeDTO>>>
    {
        private readonly IEmployeeService _employeeService;
        public GetEmployeesByFacilityQueryHandler(IEmployeeService employeeService) => _employeeService = employeeService;
        public async Task<IdentityResult<IEnumerable<EmployeeDTO>>> Handle(GetEmployeesByFacilityQuery request, CancellationToken cancellationToken)
        {
