namespace GHR.EmployeeManagement.Application.Queries.GetEmployeesByStatus
{
    ...
    public class GetEmployeesByStatusQueryHandler : IRequestHandler<GetEmployeesByStatusQuery, IdentityResult<IEnumerable<EmployeeDTO>>>
    {
        private readonly IEmployeeService _employeeService;

        public GetEmployeesByStatusQueryHandler(IEmployeeService employeeService) => _employeeService = employeeService;
         public async Task<IdentityResult<IEnumerable<EmployeeDTO>>> Handle(GetEmployeesByStatusQuery request, CancellationToken cancellationToken)
        {
