namespace GHR.EmployeeManagement.Application.Queries.GetEmployeeById
{
    ...
    public class GetEmployeeByIdQueryHandler : IRequestHandler<GetEmployeeByIdQuery, IdentityResult<EmployeeDTO>>
    {
        private readonly IEmployeeService _employeeService; 
        public GetEmployeeByIdQueryHandler(IEmployeeService employeeService) => _employeeService = employeeService;
        public async Task<IdentityResult<EmployeeDTO>> Handle(GetEmployeeByIdQuery request, CancellationToken cancellationToken)
        {
