namespace GHR.Rating.Application.Queries.GetAwardsByPeriod
{
    ...
    public class GetAwardsByPeriodQueryHandler : IRequestHandler<GetAwardsByPeriodQuery, IdentityResult<IEnumerable<Award>>>
    {
        private readonly IAwardService _awardService; 
        public GetAwardsByPeriodQueryHandler(IAwardService awardService) => _awardService = awardService; 
        public async Task<IdentityResult<IEnumerable<Award>>> Handle(GetAwardsByPeriodQuery request, CancellationToken cancellationToken)
        {
