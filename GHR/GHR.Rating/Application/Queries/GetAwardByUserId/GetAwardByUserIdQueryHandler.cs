namespace GHR.Rating.Application.Queries.GetAwardByUserId
{
    ...
    public class GetAwardByUserIdQueryHandler : IRequestHandler<GetAwardByUserIdQuery, IdentityResult<RatingDto>>
    {
        private readonly IRatingService _ratingService; 
        public GetAwardByUserIdQueryHandler(IRatingService ratingService) => _ratingService = ratingService;  
        public async Task<IdentityResult<RatingDto>> Handle(GetAwardByUserIdQuery request, CancellationToken cancellationToken)
        {
