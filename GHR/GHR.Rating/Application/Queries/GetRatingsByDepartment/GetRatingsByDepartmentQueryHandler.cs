namespace GHR.Rating.Application.Queries
{
    ...
    public class GetRatingsByDepartmentQueryHandler : IRequestHandler<GetRatingsByDepartmentQuery, IdentityResult<IEnumerable<RatingDto>>>
    {
        private readonly IRatingService _ratingService; 
        public GetRatingsByDepartmentQueryHandler(IRatingService ratingService) => _ratingService = ratingService;  
        public async Task<IdentityResult<IEnumerable<RatingDto>>> Handle(GetRatingsByDepartmentQuery request, CancellationToken cancellationToken)
        {
