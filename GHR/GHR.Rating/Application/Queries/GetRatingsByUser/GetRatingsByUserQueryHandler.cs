namespace GHR.Rating.Application.Queries
{
    ...
    public class GetRatingsByUserQueryHandler : IRequestHandler<GetRatingsByUserQuery, IdentityResult<IEnumerable<RatingDto>>>
    {
        private readonly IRatingService _ratingService; 
        public GetRatingsByUserQueryHandler(IRatingService ratingService) => _ratingService = ratingService; 
        public async Task<IdentityResult<IEnumerable<RatingDto>>> Handle(GetRatingsByUserQuery request, CancellationToken cancellationToken)
        {
