namespace GHR.Rating.Application.Handlers
{
    ...
    public class ApproveRatingCommandHandler : IRequestHandler<ApproveRatingCommand, IdentityResult<bool>>
    {
        private readonly IRatingService _ratingService; 
        public ApproveRatingCommandHandler(IRatingService ratingService) => _ratingService = ratingService;  
        public async Task<IdentityResult<bool>> Handle(ApproveRatingCommand request, CancellationToken cancellationToken)
        {
