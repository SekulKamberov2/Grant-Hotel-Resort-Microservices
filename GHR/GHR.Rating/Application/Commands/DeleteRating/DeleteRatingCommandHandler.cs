namespace GHR.Rating.Application.Commands.DeleteRating
{
    ...
    public class DeleteRatingCommandHandler : IRequestHandler<DeleteRatingCommand, IdentityResult<bool>>
    {
        private readonly IRatingService _ratingService;
        public DeleteRatingCommandHandler(IRatingService ratingService) => _ratingService = ratingService;
        public async Task<IdentityResult<bool>> Handle(DeleteRatingCommand request, CancellationToken cancellationToken)
        {
