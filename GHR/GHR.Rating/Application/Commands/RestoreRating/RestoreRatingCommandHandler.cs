namespace GHR.Rating.Application.Commands.RestoreRating
{
    ...
    public class RestoreRatingCommandHandler : IRequestHandler<RestoreRatingCommand, IdentityResult<bool>>
    {
        private readonly IRatingService _ratingService; 
        public RestoreRatingCommandHandler(IRatingService ratingService) => _ratingService = ratingService;  
        public async Task<IdentityResult<bool>> Handle(RestoreRatingCommand request, CancellationToken cancellationToken)
        {
