namespace GHR.Rating.Application.Commands.FlagRating
{
    ...
    public class FlagRatingCommandHandler : IRequestHandler<FlagRatingCommand, IdentityResult<bool>>
    {
        private readonly IRatingService _ratingService;
        public FlagRatingCommandHandler(IRatingService ratingService) => _ratingService = ratingService;
        public async Task<IdentityResult<bool>> Handle(FlagRatingCommand request, CancellationToken cancellationToken)
        {
