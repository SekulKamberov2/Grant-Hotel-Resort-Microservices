namespace GHR.Rating.Application.Commands.AwardTopPerformers
{
    ...
    public class AwardTopPerformersCommandHandler : IRequestHandler<AwardTopPerformersCommand, IdentityResult<List<Award>>>
    {
        private readonly IAwardService _awardService; 
        public AwardTopPerformersCommandHandler(IAwardService awardService) => _awardService = awardService; 
        public async Task<IdentityResult<List<Award>>> Handle(AwardTopPerformersCommand request, CancellationToken cancellationToken)
        {
